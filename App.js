...
const ResturantCard = ({
  ...
  return (
    <div className="res-card">
      <img src={URl_image + cloudinaryImageId} alt="dominos" />
  ...
  return (
    <div className="body">
      ...
      <div className="res-container">
        {resturanrList.map((resturant) => {
          return <ResturantCard {...resturant.info} key={resturant.info.id} />;
        })}
        {/* <ResturantCard {...resturanrList[0].info} />
        <ResturantCard {...resturanrList[1].info} />
        <ResturantCard {...resturanrList[2].info} /> */}
      </div>
    </div>
  );
};
